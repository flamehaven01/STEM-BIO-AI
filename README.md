...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/stable-v1.7.5-informational.svg" alt="v1.7.5"></a>
...
In the current `1.7.5` line, AIRI is used through three local governed layers:
...
Current concept DOI-backed archive for the `1.7.5` line:
