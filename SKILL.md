...
stem-ai/
  ...
  memory/                     <-- MICA v0.2.0 memory layer (load first)
    ...
    stem-ai.mica.v1.6.0.json  <-- active archive (selected by mica.yaml)
    stem-ai-playbook.v1.6.0.md <-- active session protocol (selected by mica.yaml)
    stem-ai-lessons.v1.6.0.md  <-- active lessons history (selected by mica.yaml)
