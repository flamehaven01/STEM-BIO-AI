...
stem-ai/
  ...
  memory/                     <-- MICA v0.2.0 memory layer (load first)
    ...
    stem-ai.mica.v1.5.10.json  <-- active archive (selected by mica.yaml)
    stem-ai-playbook.v1.5.10.md <-- active session protocol (selected by mica.yaml)
    stem-ai-lessons.v1.5.10.md  <-- active lessons history (selected by mica.yaml)
...
0. **Load MICA memory layer first (before any audit work):**
   ...
   - Report: `[MICA READY] stem-ai-bio v1.5.10 | invariants: 18 active`
