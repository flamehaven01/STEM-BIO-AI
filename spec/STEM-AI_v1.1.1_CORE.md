...
```json
{
  ...
  "change_from_1_1_0": [
    ...
    "PATCH-45: Technical-audit relationship statement formalized -- technical audit = fact extraction layer; STEM BIO-AI = trust classification layer"
  ],
  "release": "2026-03"
}
```
...
```markdown
# STEM BIO-AI Trustworthiness Audit Report v1.1.1
...
This audit report is generated by an LLM executing the STEM BIO-AI v1.1.1
...
```yaml
# STEM BIO-AI INPUT TEMPLATE v1.1.1
...
On confirmed input, STEM BIO-AI Audit Report v1.1.1 generation begins immediately.
...
Version:   1.1.1
Status:    ACTIVE
Supersedes: STEM BIO-AI 1.0.0 through 1.0.5
