...
| Stage 3 Code/Bio Responsibility | 0.40 | 81 |
| Risk Penalty | -- | 10 |
...
## Code Integrity
- **C1_hardcoded_credentials:** FAIL — api_key="super-secret-ke
- **C2_dependency_pinning:** WARN — Unpinned or loosely pinned dependencies detected.
...
- **T3_changelog_release_hygiene:** 15 / 15 — CHANGELOG.md
- **B1_data_provenance_controls:** 15 / 15 — Dependency/provenance manifest detected.
...
- **stage_3_raw_total:** 65 / 80 — Raw rubric total before normalization to 100.
...
- **stage_4_raw_total:** 55 / 100 — Raw Stage 4 rubric total. Stage 4 is reported separately and does not alter final score in v1.3.0.
