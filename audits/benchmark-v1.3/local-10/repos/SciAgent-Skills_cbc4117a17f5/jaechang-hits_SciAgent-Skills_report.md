...
**Target:** `jaechang-hits/SciAgent-Skills`
...
| Stage 3 Code/Bio Responsibility | 0.40 | 35 |
| Risk Penalty | -- | 0 |

## Replication Evidence Lane

**Stage 4 Replication Score:** **5 / 100**
**Replication Tier:** **R0**
...
- **T2_domain_tests:** 8 / 15 — Tests present but domain specificity is limited.
...
- **stage_3_raw_total:** 28 / 80 — Raw rubric total before normalization to 100.
...
- **stage_4_raw_total:** 5 / 100 — Raw Stage 4 rubric total. Stage 4 is reported separately and does not alter final score in v1.3.0.
