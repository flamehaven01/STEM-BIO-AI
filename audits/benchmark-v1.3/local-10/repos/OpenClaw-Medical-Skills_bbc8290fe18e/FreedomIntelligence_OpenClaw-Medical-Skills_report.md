...
**Target:** `FreedomIntelligence/OpenClaw-Medical-Skills`
...
**Stage 4 Replication Score:** **10 / 100**
**Replication Tier:** **R0**
...
- **stage_4_raw_total:** 10 / 100 — Raw Stage 4 rubric total. Stage 4 is reported separately and does not alter final score in v1.3.0.
